...
SELECT MONTH(DataTransazione) AS Mese, ROUND(sum(prodotti_dataset.Prezzo*transazioni_dataset.QuantitaAcquistata),2) AS TOTVendite
...
-- DOMANDA NUMERO 2: Identifica i tre prodotti più venduti e la loro quantità venduta.
...
-- DOMANDA NUMERO 3: Trova il cliente che ha effettuato il maggior numero di acquisti.
...
-- DOMANDA NUMERO 4: Calcola il valore medio di ogni transazione.
SELECT AVG(prodotti_dataset.Prezzo*transazioni_dataset.QuantitaAcquistata+ImportoSpedizione) AS Media
FROM transazioni_dataset
JOIN prodotti_dataset ON prodotti_dataset.ProdottoID=transazioni_dataset.ProdottoID;


-- DOMANDA NUMERO 5: Determina la categoria di prodotto con il maggior numero di vendite.
...
-- DOMANDA NUMERO 6: Identifica il cliente con il maggior valore totale di acquisti.
...
-- DOMANDA NUMERO 7: Calcola la percentuale di spedizioni con "Consegna Riuscita"
...
-- DOMANDA NUMERO 8: Trova il prodotto con la recensione media più alta.
...
-- DOMANDA NUMERO 9: Calcola la variazione percentuale nelle vendite rispetto al mese precedente (METODO CON FUNZIONE WITH)
...
-- DOMANDA NUMERO 10: Determina la quantità media disponibile per categoria di prodotto.
...
-- DOMANDA NUMERO 11: Trova il metodo di spedizione più utilizzato.
...
-- DOMANDA NUMERO 12: Calcola il numero medio di clienti registrati al mese.
...
-- DOMANDA NUMERO 13: Identifica i prodotti con una quantità disponibile inferiore alla media
